/**
 * Unicorn Admin Template Version 2.2.0 Diablo9983 -> diablo9983@gmail.com
 */
$(function() {
	...
	$(window).on(
			...
			function() {
				...
				if (wwidth >= 768 && wwidth <= 991) {
					$('#sidebar > ul > li.open ul').attr('style', '').parent()
							.removeClass('open');
					ul.css({
						'display' : 'block'
					});
	...
	$('.go-full-screen').click(function() {
		...
		/*
		 * if($('body > .white-backdrop').length <= 0) { $('<div
		 * class="white-backdrop">').appendTo('body'); }
		 */
	...
	// IE7
	$(function($) {
		$("input[type=text], input[type=password], textarea").bind(
				'focus blur', function() {
