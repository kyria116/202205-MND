            ...
            <div id="loginbox">            
                <form id="loginform" action="../system/check.php" method="post">
                    ...
                    <div class="input-group input-sm">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span><input class="form-control" type="text" name="username" placeholder="<?php echo $cms_lang[3][$language];?>" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')"/>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-lock"></i></span><input class="form-control" type="password" name="password" placeholder="<?php echo $cms_lang[4][$language];?>" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')"/>
                    </div>
